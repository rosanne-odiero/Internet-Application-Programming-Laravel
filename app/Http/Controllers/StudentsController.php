...
class StudentsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('rosanne.pages.students')->with('data',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $student->save();
        return redirect('/')->with('success','Student Registered Succesfully');
    }
    ...
    public function search(Request $request){
        ...
        $student = Student::select('students.student_id','students.fullname','fees.amount','fees.dateofpayment')
                            ...
                            // return $student;
        return view('rosanne.pages.student')->with('student',$student)->with('studentDetail',$studentDetail);
    }
}
